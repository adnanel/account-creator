...
class CulebraTests(CulebraTestCase):
    ...
    def setUpClass(cls):
        ...
        cls.options = {'find-views-by-id': True, 'find-views-with-text': True, 'find-views-with-content-description': True, 'use-regexps': False, 'verbose-comments': False, 'unit-test-class': True, 'unit-test-method': None, 'use-jar': False, 'use-dictionary': False, 'dictionary-keys-from': 'id', 'auto-regexps': None, 'start-activity': None, 'output': 'myTestCase.py', 'interactive': False, 'window': -1, 'prepend-to-sys-path': False, 'save-screenshot': None, 'save-view-screenshots': None, 'gui': True, 'do-not-verify-screen-dump': False, 'scale': 0.5, 'orientation-locked': None, 'multi-device': False, 'log-actions': True, 'device-art': None, 'drop-shadow': False, 'glare': False, 'null-back-end': False, 'concertina': False, 'concertina-config': None, 'install-apk': None}
        cls.sleep = 5
    ...
    def testSomething(self):
        ...
        self.device.Log.d(TAG, "finding view with text=u'Read our Privacy Policy. Tap \"Agree and continue\" to accept the Terms of Service.'",  _v)
        com_whatsapp___id_eula_view = self.vc.findViewWithTextOrRaise(u'Read our Privacy Policy. Tap "Agree and continue" to accept the Terms of Service.')
        ...
        com_whatsapp___id_register_phone_toolbar_title = self.vc.findViewByIdOrRaise("com.whatsapp:id/register_phone_toolbar_title")
        ...
        self.device.Log.d(TAG, "finding view with text=u'''WhatsApp will need to verify your phone number. What's my number?'''",  _v)
        com_whatsapp___id_description = self.vc.findViewWithTextOrRaise(u'''WhatsApp will need to verify your phone number. What's my number?''')
        ...
        com_whatsapp___id_registration_country = self.vc.findViewWithContentDescriptionOrRaise(u'''Selected country, United States''')
        ...
        self.vc.findViewWithTextOrRaise(u'1').setText(u"387")
        self.vc.sleep(_s)
        self.device.Log.d(TAG, "dumping content of window=-1",  _v)
        self.vc.dump(window=-1)
        ...
        self.device.Log.d(TAG, "finding view with content-description=u'''Selected country, Bosnia & Herzegovina'''",  _v)
        com_whatsapp___id_registration_country = self.vc.findViewWithContentDescriptionOrRaise(u'''Selected country, Bosnia & Herzegovina''')
        self.device.Log.d(TAG, "finding view with id=com.whatsapp:id/registration_cc",  _v)
        com_whatsapp___id_registration_cc = self.vc.findViewByIdOrRaise("com.whatsapp:id/registration_cc")
        self.device.Log.d(TAG, "finding view with text=u'387'",  _v)
        com_whatsapp___id_registration_cc = self.vc.findViewWithTextOrRaise(u'387')
        self.device.Log.d(TAG, "finding view with id=id/no_id/9",  _v)
        no_id9 = self.vc.findViewByIdOrRaise("id/no_id/9")
        self.device.Log.d(TAG, "finding view with text=u'+'",  _v)
        no_id9 = self.vc.findViewWithTextOrRaise(u'+')
        ...
        self.vc.findViewWithTextOrRaise(u'phone number').setText(u"63953402")
        self.vc.sleep(_s)
        self.device.Log.d(TAG, "dumping content of window=-1",  _v)
        self.vc.dump(window=-1)
        ...
        self.device.Log.d(TAG, "finding view with id=com.whatsapp:id/registration_phone",  _v)
        com_whatsapp___id_registration_phone = self.vc.findViewByIdOrRaise("com.whatsapp:id/registration_phone")
        self.device.Log.d(TAG, "finding view with text=u'63 953 402'",  _v)
        com_whatsapp___id_registration_phone = self.vc.findViewWithTextOrRaise(u'63 953 402')
        self.device.Log.d(TAG, "finding view with id=com.whatsapp:id/carrier_charge_warning",  _v)
        com_whatsapp___id_carrier_charge_warning = self.vc.findViewByIdOrRaise("com.whatsapp:id/carrier_charge_warning")
        self.device.Log.d(TAG, "finding view with text=u'Carrier charges may apply'",  _v)
        com_whatsapp___id_carrier_charge_warning = self.vc.findViewWithTextOrRaise(u'Carrier charges may apply')
        ...
        self.device.Log.d(TAG, "finding view with text=u'''You entered the phone number:\n\n+387 63 953 402\n\nIs this OK, or would you like to edit the number?'''",  _v)

        android___id_message = self.vc.findViewWithTextOrRaise(u'''You entered the phone number:\n\n+387 63 953 402\n\nIs this OK, or would you like to edit the number?''')
        ...
        self.device.Log.d(TAG, "finding view with text=u'Waiting to automatically detect an SMS sent to +387 63 953 402. Wrong number?'",  _v)
        com_whatsapp___id_description_2_top = self.vc.findViewWithTextOrRaise(u'Waiting to automatically detect an SMS sent to +387 63 953 402. Wrong number?')
        self.device.Log.d(TAG, "finding view with id=id/no_id/6",  _v)
        no_id6 = self.vc.findViewByIdOrRaise("id/no_id/6")
        ...
        com_whatsapp___id_progress_bar_code_input_blocked = self.vc.findViewByIdOrRaise("com.whatsapp:id/progress_bar_code_input_blocked")
        ...
        self.vc.findViewWithTextOrRaise(u'––– –––').setText(u"597649")
        self.vc.sleep(_s)
        self.device.Log.d(TAG, "dumping content of window=-1",  _v)
        self.vc.dump(window=-1)
        ...
        self.device.Log.d(TAG, "finding view with text=u'To easily send messages and photos to friends and family, allow WhatsApp to access your contacts, photos and other media.'",  _v)
        com_whatsapp___id_permission_message = self.vc.findViewWithTextOrRaise(u'To easily send messages and photos to friends and family, allow WhatsApp to access your contacts, photos and other media.')
        ...
        self.device.Log.d(TAG, "finding view with id=com.whatsapp:id/permission_message",  _v)
        com_whatsapp___id_permission_message = self.vc.findViewByIdOrRaise("com.whatsapp:id/permission_message")
        self.device.Log.d(TAG, "finding view with text=u'To find and restore your backup from Google Drive, allow WhatsApp to access your contacts, photos and other media.'",  _v)
        com_whatsapp___id_permission_message = self.vc.findViewWithTextOrRaise(u'To find and restore your backup from Google Drive, allow WhatsApp to access your contacts, photos and other media.')
        self.device.Log.d(TAG, "finding view with id=com.whatsapp:id/cancel",  _v)
        com_whatsapp___id_cancel = self.vc.findViewByIdOrRaise("com.whatsapp:id/cancel")
        ...
        com_whatsapp___id_biz_info_description = self.vc.findViewWithTextOrRaise(u'Please provide your name and an optional profile photo')
        ...
        com_whatsapp___id_name_counter_tv = self.vc.findViewWithContentDescriptionOrRaise(u'''20 characters remaining''')
        self.device.Log.d(TAG, "finding view with id=com.whatsapp:id/emoji_btn",  _v)
        com_whatsapp___id_emoji_btn = self.vc.findViewByIdOrRaise("com.whatsapp:id/emoji_btn")
        self.device.Log.d(TAG, "finding view with content-description=u'''Emoji'''",  _v)
        com_whatsapp___id_emoji_btn = self.vc.findViewWithContentDescriptionOrRaise(u'''Emoji''')
        ...
        com_whatsapp___id_conversations_empty_permission_denied = self.vc.findViewByIdOrRaise("com.whatsapp:id/conversations_empty_permission_denied")
        self.device.Log.d(TAG, "finding view with id=id/no_id/4",  _v)
        no_id4 = self.vc.findViewByIdOrRaise("id/no_id/4")
        self.device.Log.d(TAG, "finding view with id=id/no_id/5",  _v)
        no_id5 = self.vc.findViewByIdOrRaise("id/no_id/5")
        self.device.Log.d(TAG, "finding view with text=u'To help you message friends and family on WhatsApp, allow WhatsApp access to your contacts. Tap Settings > Permissions, and turn Contacts on.'",  _v)
        no_id5 = self.vc.findViewWithTextOrRaise(u'To help you message friends and family on WhatsApp, allow WhatsApp access to your contacts. Tap Settings > Permissions, and turn Contacts on.')
        self.device.Log.d(TAG, "finding view with id=com.whatsapp:id/button_open_permission_settings",  _v)
        com_whatsapp___id_button_open_permission_settings = self.vc.findViewByIdOrRaise("com.whatsapp:id/button_open_permission_settings")
